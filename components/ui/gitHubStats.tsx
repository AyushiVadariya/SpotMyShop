    ...
    const getStarForkCount = async () => {
      try {
        const response = await fetch(
          `https://api.github.com/repos/mdazfar2/SpotMyShop`
        )
            ...
            <div className= 'h-full flex flex-col lg:flex-row items-center justify-around'>
                ...
                <div className= 'flex sm:flex-row flex-col items-center justify-center gap-10 mt-4 lg:mt-0 w-full '>
                    ...
                    <RatingForkComponent
                        ...
                        link="https://github.com/AyushiVadariya/SpotMyShop"
                        bgColor="#575448"
                        btnBgColor="#FBD449"
                    ...
                    <RatingForkComponent
                        ...
                        link="https://github.com/AyushiVadariya/SpotMyShop/blob/main/CONTRIBUTING.md"
                        bgColor="#403B56"
                        btnBgColor="#4CAF50"
