  ...
  const flow = [
    {
      id: "1",
      message:
        "Welcome to **SpotMyShop**, your one-stop shop for everything you need! What is your name?",
      trigger: "2",
    },
    {
      id: "2",
    ...
    {
      id: "16",
      message: "Here are some top vendors on SpotMyShop:",
      trigger: "17",
    },
    {
      id: "17",
    ...
    {
      id: "14",
      message: "Thank you for using SpotMyShop! Enjoy your shopping experience!",
      end: true,
    },
  ];
