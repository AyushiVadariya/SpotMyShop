...
export async function sendSubscriptionWelcomeEmail(name: string, email: string) {
  try {
    ...
    if (existingSubscription) {
      return {
        success: false,
        message: "This email is already subscribed to the SpotMyShop newsletter.",
      };
    }

    // Customize welcome email with user's name
    const subject = `Hi ${name}, Welcome to SpotMyShop!`;
    const html = `
      <div style="font-family: Arial, sans-serif; color: #333;">
        <h1 style="color: #ff6600;">SpotMyShop</h1>
        <h2>Welcome to the SpotMyShop Family, ${name}! 🎉</h2>
        <p>We're thrilled to have you with us! 🛍️</p>
        <p>Hi ${name},</p>
        <p>Thank you for subscribing to the SpotMyShop Newsletter! 🎉 We're excited to bring you exclusive offers, updates, and insights from the world of e-commerce.</p>
        ...
        <ul>
          ...
          <li>🛒 <strong>Shopping Guides</strong>: Get tips and insights to make the most out of your shopping experience at SpotMyShop.</li>
        ...
        <p>Best regards,</p>
        <p><strong>The SpotMyShop Team 🛒</strong></p>
