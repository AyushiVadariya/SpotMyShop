      ...
      <div
        ...
        >
          ...
          <div className="mt-5 text-md lg:text-lg lg:text-white text-center text-gray-800 dark:text-white">
            SpotMyShop makes it easy to browse, order, and receive products from
        ...
        <div className="flex rounded-2xl my-10 lg:my-0 justify-between shadow-xl shadow-black dark:shadow-Green relative w-full lg:h-4/6 lg:w-2/4 border overflow-hidden">
          ...
          <div
            className={`w-full h-full hidden lg:block absolute right-80 bottom-[9.5rem] -rotate-45 transition-opacity duration-1000 ease-in-out bg-customTeal dark:bg-gradient-to-r from-Green to-Yellow ${
              !switchCss ? "opacity-100" : "opacity-0"
            }`}
          ></div>
          ...
          <div
            className={`text-white pt-19 hidden md:flex px-4 flex-col w-2/3 ${
