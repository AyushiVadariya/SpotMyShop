    ...
    const fetchContributors = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/AyushiVadariya/Spot"
        );
                    ...
                    <div className="text-center mt-5 w-64 mx-auto md:mx-3 md:w-48 md:mt-10 order-2 md:order-1">
                      ...
                      <div className="mt-2">
                        <span
                          ...
                          onClick={() =>
                            window.open(
                              `https://github.com/AyushiVadariya/SpotMyShop/commits/main/?author=${contributors[2].login}`,
                              "_blank"
                            )
                          }
                        >
                    ...
                    <div className="relative text-center w-64 mx-auto md:mx-5  md:w-64 flex-shrink-0 order-1 md:order-2">
                      ...
                      <div className="mt-2">
                        <span
                          ...
                          onClick={() =>
                            window.open(
                              `https://github.com/AyushiVadariya/SpotMyShop/commits/main/?author=${contributors[1].login}`,
                              "_blank"
                            )
                          }
                        >
                    ...
                    <div className="text-center mt-5 w-64 mx-auto md:mx-3 md:w-48 md:mt-10 order-3 md:order-3">
                      ...
                      <div className="mt-2">
                        <span
                          ...
                          onClick={() =>
                            window.open(
                              `https://github.com/AyushiVadariya/SpotMyShop/commits/main/?author=${contributors[3].login}`,
                              "_blank"
                            )
                          }
                        >
