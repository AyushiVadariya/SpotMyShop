...
export const metadata: Metadata = {
  title: "SpotMyShop - Teams",
  description: "Meet the talented team behind SpotMyShop, dedicated to creating the best shopping experience.",
};
...
const Teams = () => {
  return (
    ...
    //   </div>
      ...
      // <SeperatorHeading label="SpotMyShop Founder"/>
